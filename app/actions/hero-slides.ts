...
export async function getHeroSlides() {
  try {
    ...
    // @ts-ignore
    if (!prisma.heroSlide) {
      console.error("prisma.heroSlide is undefined. Client generation might have failed.")
      return { success: false, error: "Database model not found. Please restart server." }
    }
